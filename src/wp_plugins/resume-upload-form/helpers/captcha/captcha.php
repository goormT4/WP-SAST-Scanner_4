...
$fonts = [];
$fonts[] = dirname(__FILE__) ."/fonts/DejaVuSerif-Bold.ttf";
$fonts[] = dirname(__FILE__) ."/fonts/DejaVuSans-Bold.ttf";
$fonts[] = dirname(__FILE__) ."/fonts/DejaVuSansMono-Bold.ttf";

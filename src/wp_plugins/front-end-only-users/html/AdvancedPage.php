<?php 
		$Login_Time = intval( get_option("EWD_FEUP_Login_Time") );
?>
<div class="wrap">
<div id="icon-options-general" class="icon32"><br /></div><h2>Settings</h2>

<form method="post" action="<?php echo esc_url( admin_url( 'admin.php?page=EWD-FEUP-options&DisplayPage=Advanced&Action=EWD_FEUP_UpdateAdvanced' ) ); ?>">
